package com.fitness.healthmanager.helpers
...
class NotificationHelper(val ctx: Context) {
    ...
    private val CHANNEL_ONE_ID = "com.crazytrends.healthmanager.CHANNELONE"
    ...
    fun getNotification(
        ...
        val notificationIntent = Intent(ctx, Water_MainActivity::class.java)
