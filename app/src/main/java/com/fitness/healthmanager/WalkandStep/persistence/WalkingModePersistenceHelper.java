...
public class WalkingModePersistenceHelper {
    ...
    public static final String BROADCAST_ACTION_WALKING_MODE_CHANGED = "com.crazytrends.healthmanager.WALKING_MODE_CHANGED";
    public static final String BROADCAST_EXTRA_OLD_WALKING_MODE = "com.crazytrends.healthmanager.EXTRA_OLD_WALKING_MODE";
    public static final String BROADCAST_EXTRA_NEW_WALKING_MODE = "com.crazytrends.healthmanager.EXTRA_NEW_WALKING_MODE";
