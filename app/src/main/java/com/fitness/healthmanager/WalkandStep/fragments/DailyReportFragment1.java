...
package com.fitness.healthmanager.WalkandStep.fragments;
...
import com.fitness.healthmanager.WalkandStep.Factory;
import com.fitness.healthmanager.WalkandStep.adapters.ReportAdapter1;
import com.fitness.healthmanager.WalkandStep.models.ActivityChartDataSet;
import com.fitness.healthmanager.WalkandStep.models.ActivityDayChart;
import com.fitness.healthmanager.WalkandStep.models.ActivitySummary;
import com.fitness.healthmanager.WalkandStep.models.StepCount;
import com.fitness.healthmanager.WalkandStep.models.WalkingMode;
import com.fitness.healthmanager.WalkandStep.persistence.StepCountPersistenceHelper;
import com.fitness.healthmanager.WalkandStep.persistence.WalkingModePersistenceHelper;
import com.fitness.healthmanager.WalkandStep.services.AbstractStepDetectorService;
import com.fitness.healthmanager.WalkandStep.services.MovementSpeedService;
...
public class DailyReportFragment1 extends Fragment implements ReportAdapter1.OnItemClickListener, SharedPreferences.OnSharedPreferenceChangeListener {
    public static String LOG_TAG = DailyReportFragment1.class.getName();
    private final BroadcastReceiver broadcastReceiver = new BroadcastReceiver();
    private ReportAdapter1 mAdapter;
    ...
    public DailyReportFragment1() {
        // Required empty public constructor
    }


    public static DailyReportFragment1 newInstance() {
        DailyReportFragment1 fragment = new DailyReportFragment1();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_daily_report1, container, false);
        ...
        mAdapter = new ReportAdapter1(reports);
...
//        }
    ...
    private void generateReports(boolean updated) {
        ...
        String d = sharedPref.getString(context.getString(R.string.pref_daily_step_goal), "5000");
    ...
    public void onTitleClicked() {
        ...
        DatePickerDialog dialog = new DatePickerDialog(getContext(), R.style.AppTheme_walk_DatePickerDialog, new DatePickerDialog.OnDateSetListener() {
            @Override
            public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                DailyReportFragment1.this.day.set(Calendar.DAY_OF_MONTH, dayOfMonth);
                DailyReportFragment1.this.day.set(Calendar.MONTH, monthOfYear);
                DailyReportFragment1.this.day.set(Calendar.YEAR, year);
                DailyReportFragment1.this.generateReports(false);
                if (isTodayShown() && StepDetectionServiceHelper.isStepDetectionEnabled(getContext())) {
                    bindService();
                }
            }
    ...
    public void onWalkingModeClicked(int id) {
        if (menuWalkingModes.containsKey(id)) {
            ...
            AlertDialog.Builder alert = new AlertDialog.Builder(this.getContext(), R.style.AppTheme_walk_Dialog);
