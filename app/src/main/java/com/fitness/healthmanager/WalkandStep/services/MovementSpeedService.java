...
public class MovementSpeedService extends IntentService implements LocationListener, SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public static final String BROADCAST_ACTION_SPEED_CHANGED = "com.crazytrends.healthmanager.SPEED_CHANGED";


    public static final String EXTENDED_DATA_CURRENT_SPEED = "com.crazytrends.healthmanager.CURRENT_SPEED";
