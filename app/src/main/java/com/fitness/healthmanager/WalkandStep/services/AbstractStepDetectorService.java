...
package com.fitness.healthmanager.WalkandStep.services;
...
import com.fitness.healthmanager.WalkandStep.activities.TrainingActivity;
...
import com.fitness.healthmanager.WalkandStep.persistence.TrainingPersistenceHelper;
...
public abstract class AbstractStepDetectorService extends IntentService implements SensorEventListener, SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public static final String BROADCAST_ACTION_STEPS_DETECTED = "com.crazytrends.healthmanager.STEPS_DETECTED";

    public static final String EXTENDED_DATA_NEW_STEPS = "com.crazytrends.healthmanager.NEW_STEPS";

    public static final String EXTENDED_DATA_TOTAL_STEPS = "com.crazytrends.healthmanager.TOTAL_STEPS";
