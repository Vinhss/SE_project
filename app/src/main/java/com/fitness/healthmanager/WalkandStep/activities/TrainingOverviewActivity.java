...
import com.fitness.healthmanager.WalkandStep.adapters.TrainingOverviewAdapter;
...
//        actionBar.setBackgroundDrawable(new ColorDrawable("COLOR"));
    ...
    protected void showEditDialog(final Integer position) {
        AlertDialog.Builder alert = new AlertDialog.Builder(TrainingOverviewActivity.this, R.style.AppTheme_walk_Dialog);
