...
package com.fitness.healthmanager.WalkandStep.adapters;
...
import com.fitness.healthmanager.WalkandStep.models.ActivityChart;
...
import com.fitness.healthmanager.WalkandStep.utils.UnitHelper;
...
public class ReportAdapter1 extends RecyclerView.Adapter<ReportAdapter1.ViewHolder> {
    ...
    public ReportAdapter1(List<Object> items) {
        mItems = items;
    }
        ...
        switch (viewType) {
            ...
            case TYPE_CHART:
                v = LayoutInflater.from(parent.getContext())
                        .inflate(R.layout.card_activity_bar_chart1, parent, false);
                vh = new CombinedChartViewHolder(v);
                break;

            case TYPE_DAY_CHART:
                v = LayoutInflater.from(parent.getContext())
                        .inflate(R.layout.card_activity_chart1, parent, false);
            ...
            default:
                ...
                v = LayoutInflater.from(parent.getContext())
                        .inflate(R.layout.card_activity_summary1, parent, false);
...
//            legend.setCustom(new ArrayList<>(legendValues.keySet()), new ArrayList<>(legendValues.values()));
            ...
            case TYPE_SUMMARY:
                final ActivitySummary summaryData = (ActivitySummary) mItems.get(position);
                ...
                new Thread(new Runnable() {
                    @Override
                    public void run() {
                        while (pStatus <= summaryData.getSteps()) {
                            handler.post(new Runnable() {
                                @Override
                                public void run() {
                                    progressBar.setProgress(pStatus);
                                    progressBar.setMax(500);
                                    txtProgress.setText(String.valueOf(summaryData.getSteps()));
...
//            tv1 = (TextView) itemView.findViewById(R.id.b_steps);
//            tv2 = (TextView) itemView.findViewById(R.id.b_distance);
//            tv3 = (TextView) itemView.findViewById(R.id.b_calories);
    ...
    public class ArrayListAxisValueFormatter extends ValueFormatter implements AxisValueFormatter {
