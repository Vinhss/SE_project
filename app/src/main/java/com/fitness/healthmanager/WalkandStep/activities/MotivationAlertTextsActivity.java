...
import com.fitness.healthmanager.WalkandStep.adapters.MotivationAlertTextsAdapter;
...
public class MotivationAlertTextsActivity extends AppCompatActivity implements MotivationAlertTextsAdapter.OnItemClickListener {
    ...
    protected void showEditDialog(final Integer position) {
        AlertDialog.Builder alert = new AlertDialog.Builder(MotivationAlertTextsActivity.this, R.style.AppTheme_walk_Dialog);
